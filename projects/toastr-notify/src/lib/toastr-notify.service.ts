...
export class ToastrNotifyService {
  ...
  showWarning(message:string):void{
    ...
    const close_warning = this.domsanitizer.bypassSecurityTrustHtml(`<svg xmlns="http://www.w3.org/2000/svg" width="19" style="cursor: pointer" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#cc8925" class="w-6 h-6"> <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" /> </svg>`)
  ...
  showInfo(message:string):void{
    ...
    const close_info = this.domsanitizer.bypassSecurityTrustHtml(`<svg xmlns="http://www.w3.org/2000/svg" width="19" style="cursor: pointer" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#3b82f6" class="w-6 h-6"> <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" /> </svg>`)
  ...
  showDanger(message:string):void{
    ...
    const close_danger = this.domsanitizer.bypassSecurityTrustHtml(`<svg xmlns="http://www.w3.org/2000/svg" width="19" style="cursor: pointer" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ff5757" class="w-6 h-6"> <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" /> </svg>`)
